...
export default function BusinessHosting() {
  return (
    ...
    >
      ...
      <section id="learn-more" className="py-16 bg-white text-gray-900 scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">            
            {/* Left Column - Description */}
            <div>
              <h2 className="text-4xl font-bold font-heading mb-4">Optimized Hosting for Your WordPress Site</h2>
            ...
            {/* Right Column - Features + Price */}
              <div className="bg-white p-8 rounded-lg shadow text-center border border-gray-200">              <h3 className="text-3xl font-semibold mb-4">$99 / mo</h3>              
