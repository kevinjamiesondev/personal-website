export default function Hero() {
  return (
    ...
    >
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-white/30 dark:from-gray-900/30 via-white/80 dark:via-gray-900/80 to-[#4E3629]/30 dark:to-black/50"></div>
